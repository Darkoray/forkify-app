...
const KEY = 'b7e8349f-596e-41cf-89f3-33ecd7cf4e7f';
...
var _config = require("./config");
// Helper function to reject promise if request takes too long
...
// Class representing a recipe view
class RecipeView extends (0, _viewDefault.default) {
    _parentElement = document.querySelector('.recipe');
    _errorMessage = `We couldn't find that recipe. Please try another one!`;
    _message = '';
    // Add event handler for updating servings
    ...
    // Add event handler for adding a bookmark
    ...
    _generateMarkupIng(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${ing.quantity ? new (0, _fractionJsDefault.default)(ing.quantity).toFraction(true).toString() : ''}</div>
    ...
    // Add event handler for rendering the recipe
...
class View {
   ...
   */ render(data, render = true) {
    ...
    // Update only changed elements to avoid full re-render
    update(data) {
        this._data = data;
...
},{"./view":"2kjY2","./previewView":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
// Class representing the preview
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkupButton(type) {
        ...
        const svg = /*html*/ `
      <svg class="search__icon">
        <use href="${(0, _iconsSvgDefault.default)}#icon-arrow-${pageIcon}"></use>
      </svg>
    `;
        return /*html*/ `
...
},{"./view":"2kjY2","./previewView":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
//# sourceMappingURL=18-Forkify_App_Building_a_Modern_Application.4a59a05f.js.map
